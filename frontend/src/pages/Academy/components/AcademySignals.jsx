...
function AcademySignals() {
  return (
    <section className="my-8 mb-10 flex flex-wrap gap-2.5 relative z-[2] md:gap-2" aria-label="Academy outcomes">
      <div className="rounded-full py-2.5 px-3.5 bg-white border border-[rgba(31,31,36,0.08)] text-academy-deep text-xs font-bold uppercase tracking-[0.5px] md:text-[11px]">
